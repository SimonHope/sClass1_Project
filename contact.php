                            ...
                            <form>
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" id="tel" class="form-control" placeholder="เบอร์โทรศัพท์ของคุณ">
                                    </div>
                                    <div class="form-group col-md-4">
                                ...
                                <div id="recaptcha-wrapper" class="text-center my-2">
                                    <div class="g-recaptcha d-inline-block" data-sitekey="6LdLBKcbAAAAANZaMxSFuAnYiuSBqkNIi87wW4RR"></div>
                                </div>
