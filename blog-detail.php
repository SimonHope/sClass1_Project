...
<body>
    ...
    <!-- Section Page-title -->
        <header class="jarallax" data-speed="0.5" style="background-image: url('https://images.unsplash.com/photo-1598550511769-875ef2a01663?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80');">
            <div class="page-image">
                <h1 class="display-4 font-weight-bold">เกมแนว FPS คืออะไร</h1>
                <p class="lead">"FPS&nbsp;ย่อมาจาก&nbsp;First-person shooter"</p>
            </div>
        </header>
    ...
    <!-- Section Blog -->
        <section class="container blog-content">
            <div class="row">
                <div class="col=12">
                    <h1><span style="font-size:26px"><strong>เกมแนว FPS คืออะไร</strong></span><br /></h1>
                ...
                <div class="col-12">
                    ...
                    <p class="text-right text-muted">16 กรกฎาคม 2021</p>
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                    <div class="fb-comments" data-href="https://developers.facebook.com/docs/plugins/comments#configurator3" data-width="100%" data-numposts="5"></div>
                    <div id="fb-root"></div>
